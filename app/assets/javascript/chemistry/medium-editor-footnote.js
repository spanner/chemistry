(function (root, factory) {
  ...
  return MediumEditor.extensions.button.extend({
    ...
    removeFootnoteTags: function (phrase) {
      console.log("removeFootnoteTags", phrase);
    ...
    addFootnote: function (footnoteId) {
      ...
      if (!footnote) {
        ...
        // skip cache check and dispatch input event directly
        customEvent = this.base.options.ownerDocument.createEvent('HTMLEvents');
        customEvent.initEvent('input', true, true, this.base.options.contentWindow);
        this.base.elements[0].dispatchEvent(customEvent);
      }
      return footnote;
    },
    ...
    handleClick: function (e) {
      ...
      //#TODO remove this temporary chemistry-specific layout update call :(
